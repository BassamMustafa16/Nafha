...
export default function Navbar() {
  ...
  return (
    <nav className="md:absolute top-0 left-0 flex flex-col md:flex-row w-full  xl:gap-10 items-center justify-center lg:text-xl bg-transparent text-black md:text-white z-10 py-5 md:py-0">
      {/* Mobile Nav */}
      ...
      <div
        className={`overflow-hidden transition-all duration-500 ease-in-out origin-top transform
          ...
          md:max-h-none`}
      >
        <div className="flex flex-col md:flex-row gap-5 items-center py-5 md:py-0">
